...
// LCP - реализация месенджера через классы, при котором в классе MessegeSender метод Send работая с классом Message, корректно работает со всеми наследниками
